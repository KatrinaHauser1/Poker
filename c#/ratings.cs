...
class ratings : IComparable<ratings> {

        public cards[] playedHand;
        ...
        public bool isAscending(cards[] playable) {
        ...
        public bool isFlush(cards[] playable) {
        ...
        public bool numDuplicates(string handtype, cards[] playable) {
        ...
        public int CompareTo(ratings other) {
                ...
                for (int i = 0; i < this.tiebreak.Length; i++) {
                        if (this.tiebreak[i] != other.tiebreak[i]) {
                                return other.tiebreak[i].CompareTo(this.tiebreak[i]);
                        }
                }
                return 0;
        }
